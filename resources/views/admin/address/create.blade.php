...
@section('styles')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-envelope-o"></i> Address
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-primary">
                    ...
                    {!! Form::open(['route' => 'admin::address.save', 'class' => 'form-horizontal']) !!}
                    <div class="box-body">
                        @if(!empty($customers))
                            <div class="form-group">
                                {!! Form::label('customer', 'Customer', ['class' => 'col-sm-2 control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::select('customer', $customers, null, ['class' => 'customer form-control']) !!}
                                </div>
                            </div>
                        @endif
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('country', array(), null, ['class' => 'country form-control']) !!}
                            </div>
                        </div>
                    </div>
